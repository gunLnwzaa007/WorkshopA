#คำนวณค่าใช้จ่ายในการซื้อแพ็กเกจท่องเที่ยวของกรุ๊ปทัวร์ ทั้งนี้รูปแบบการใช้งาน
#โปรแกรมจะต้องป้อนชื่อหัวหน้ากรุ๊ปทัวร์ เบอร์โทรศัพท์ติดต่อกลับของหัวหน้ากรุ๊ปทัวร์ และจำนวนคนที่จะไปทัวร์ 
#ทางแป้นพิมพ์ โดยในการคิดคํานวณค่าใช้จ่ายในการซื้อแพ็กเกจท่องเที่ยวของกรุ๊ปทัวร์ มีหลักเกณฑ์ในการคิด
#คำนวณ ดังนี้ 
